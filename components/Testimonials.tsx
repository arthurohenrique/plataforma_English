      ...
      <Container>
        ...
        <div className="mt-10 sm:mt-14 grid grid-cols-1 md:grid-cols-3 gap-4 sm:gap-5">
          {testimonials.map((t) => (
            <figure
              key={t.name}
              className="flex flex-col justify-between rounded-2xl sm:rounded-3xl border border-hairline bg-white p-6 sm:p-7 lg:p-8 transition-all hover:-translate-y-1 hover:shadow-[0_20px_40px_-20px_rgba(10,37,64,0.18)]"
            >
              <blockquote className="text-[16px] sm:text-[18px] leading-relaxed font-medium tracking-tight text-foreground">
                “{t.quote}”
              </blockquote>
              <figcaption className="mt-6 sm:mt-8 flex items-center gap-3 border-t border-hairline pt-4 sm:pt-5">
