...
export function FloatingWhatsApp() {
  return (
    <a
      ...
      className="fixed z-50 inline-flex h-12 w-12 sm:h-14 sm:w-14 items-center justify-center rounded-full bg-[#25D366] text-white shadow-[0_10px_30px_-10px_rgba(37,211,102,0.6)] hover:scale-105 active:scale-100 transition-transform"
    >
