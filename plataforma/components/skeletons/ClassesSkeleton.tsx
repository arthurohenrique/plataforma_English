  ...
  return (
    <PlatformShell title={title || "Aulas gravadas"}>
      <div className="p-fade-in">
        ...
        <section className="mt-8 sm:mt-10 grid grid-cols-1 lg:grid-cols-12 gap-5 sm:gap-6">
          ...
          <div className="order-2 lg:order-1 lg:col-span-5 xl:col-span-4 p-card p-3 sm:p-4 space-y-2">
            {Array.from({ length: 4 }).map((_, i) => (
              <div
                key={i}
                className="rounded-2xl border border-[color:var(--p-hairline)] bg-white px-3 sm:px-4 py-3 flex items-center gap-3"
              >
